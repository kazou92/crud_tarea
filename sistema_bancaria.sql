...
accounts.account_no ,
accounts.balance 
from clients left join accounts on 
...
client_id,
account_types."name"  
from accounts left join account_types on
accounts."type"  = account_types.id
;



select   amount, transactions_types."name"  
from transactions left join transactions_types on 
transactions.transaction_type  = transactions_types.id  
;
...
select   amount, transactions_types."name"  
from transactions right join transactions_types on 
transactions.transaction_type  = transactions_types.id  
;